...
class MockSound implements com.badlogic.gdx.audio.Sound {
    ...
    @Override public long play() { played = true; return 1; } // → überschreibt play() – merkt sich Aufruf
    @Override public long play(float volume) { played = true; return 1; } // → wird ebenfalls für andere Fälle aufgerufen
    ...
    @Override public long loop() { return 0; }                  // → Muss existieren, wird aber nicht genutzt
