...
public class ResourceBuildingRangeSystemTest {
    ...
    public void testRangeResourceCollectionCaseWood1() {
        ResourceBuildingRangeSystem resourceBuildingRangeSystem = testEngine.getSystem(ResourceBuildingRangeSystem.class);
        ...
        woodBuilding.getComponent(ResourceProductionComponent.class).productionRate.put(TiledPropertiesEnum.RESOURCE_TYPE_WOOD, 1);

        testEngine.addEntity(woodBuilding);

        resourceBuildingRangeSystem.update(0.1f);

        assertEquals(1, woodBuilding.getComponent(ResourceCollectionRangeComponent.class).tilesInRange);
    ...
    public void testRangeResourceCollectionCaseWood2() {
        ...
        assertEquals(4, woodBuilding.getComponent(ResourceCollectionRangeComponent.class).tilesInRange);
    ...
    public void testRangeResourceCollectionCaseWood3() {
        ...
        assertEquals(8, woodBuilding.getComponent(ResourceCollectionRangeComponent.class).tilesInRange);
